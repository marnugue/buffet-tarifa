...
const PoliticaPriv = (props) => {
    ...
    Legislación aplicable: Cualquier controversia que se derive del uso de este Site, será regida, interpretada y sometida de acuerdo con las leyes de España.z
        </React.Fragment>
